...
public static class Orientations
{
    ...
    public static char OrientationToChar(EOrientations orientation)
    {
        char value = ' ';
    ...
    // xToY generic converter: go

    public static Vector3Int OrientationToRotationEuler(EOrientations orientation)
    {
        OrientationEulers.TryGetValue(orientation, out Vector3Int rotationEuler);
        return rotationEuler;
    }

    public static Vector3Int OrientationToUnitVector(EOrientations orientation)
    {
        OrientationUnitVectors.TryGetValue(orientation, out Vector3Int unitVector);
        return unitVector;
    }

    public static EOrientations ReturnOrientationVal(Vector3Int directionUnitVector)
    {
    ...
    public static EOrientations ReturnDirectionVal(Vector3Int rotationVector)
    {
